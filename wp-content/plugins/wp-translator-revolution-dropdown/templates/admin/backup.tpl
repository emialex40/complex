{{ verified.false:begin }}<div id="surstudio_plugin_translator_revolution_dropdown_{{ type }}_disabled" class="surstudio_plugin_translator_revolution_dropdown_section_disabled">
...
{{ type_formatted }}
			<input id="{{ id }}_backup_button" class="button submit-button reset-button" type="button" value="{{ backup_button_message }}" onclick="SurStudioPluginTranslatorRevolutionDropDownBackup.run(); return false;" />
		</div>	
	</div>
	
	<div class="surstudio_plugin_translator_revolution_dropdown_clear"></div>
	
	<h3 class="surstudio_plugin_translator_revolution_dropdown_title" style="padding-top: 15px; margin-bottom: 15px;">{{ backup_title_message }}</h3>
	
	<div id="{{ id }}_restore_message" class="surstudio_plugin_translator_revolution_dropdown_no_display">{{ restore_message }}</div>
	
	<div id="{{ id }}_online_backups" class="surstudio_plugin_translator_revolution_dropdown_no_display"></div>
	
	<input id="{{ id }}_list_button" class="button submit-button reset-button" type="button" value="{{ list_button_message }}" onclick="SurStudioPluginTranslatorRevolutionDropDownBackup.list(); return false;" />
